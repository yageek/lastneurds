...
# Generated by qmake (2.01a) (Qt 4.5.2) on: lun. janv. 11 16:53:36 2010
...
SOURCES       = main.cpp \
		...
		editexemple.cpp \
		errorview.cpp \
		testperceptron.cpp moc_mainwindow.cpp \
...
testperceptron.o: testperceptron.cpp testperceptron.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o testperceptron.o testperceptron.cpp
